...
--
-- Name: properties fk_properties_element; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properties_element FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
...
--
-- Name: properties fk_properties_typess; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properties_typess FOREIGN KEY (type_id) REFERENCES public.types(type_id);
